---
titulo: "Abundancia"
autorLibro: "Ezra Klein y Derek Thompson"
asin: "0063487306"
categoria: negocios
recomendadoPor:
  - bill-gates
...
## Por qué lo recomiendan Bill Gates y Barack Obama
...
Ezra Klein, columnista del New York Times y cofundador de Vox, y Derek Thompson, columnista de The Atlantic, sostienen que buena parte del estancamiento estadounidense en vivienda, energía limpia, transporte y ciencia no viene de la falta de dinero o de voluntad, sino de un exceso de trabas regulatorias, muchas de ellas impulsadas originalmente por sectores progresistas para proteger al ambiente o a las comunidades. Proponen lo que llaman una "agenda de la abundancia": gastar más en construir, y a la vez simplificar las reglas que hoy frenan esa construcción.

## Un diagnóstico incómodo para varios lados

El libro generó polémica tanto en la derecha como en la izquierda estadounidense: unos lo acusan de subestimar el rol de la desregulación corporativa, otros de darle munición a esa misma desregulación. Gates no toma partido completo, pero valora que el diagnóstico obligue a repensar supuestos instalados en el debate político sobre qué es lo que realmente frena el progreso material de un país.

## Para quién es

Para quien siga de cerca política pública, economía o innovación, y quiera un argumento provocador sobre por qué construir cosas grandes se volvió tan difícil en el mundo desarrollado.

> Edición en español: *Abundancia: Cómo construimos un mundo mejor*, HarperCollins Español (traducción de Jesús Cuéllar).
