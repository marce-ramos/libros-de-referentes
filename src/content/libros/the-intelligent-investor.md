...
El libro distingue, antes que nada, entre **invertir y especular**. Invertir, para Graham, es una operación que tras un análisis riguroso promete seguridad del capital y un rendimiento razonable; todo lo demás es especulación. A partir de ahí construye una filosofía —la **inversión en valor**— basada en comprar activos por menos de lo que valen y dejar que el tiempo, no la suerte, haga el trabajo.

## Los dos conceptos que lo cambian todo
