---
titulo: "The Rise of Superman: Decoding the Science of Ultimate Human Performance"
autorLibro: "Steven Kotler"
asin: "1477800832"
...
Kotler entrevista a leyendas del deporte extremo como Laird Hamilton y Jeremy Jones, y cruza sus testimonios con la neurociencia más reciente sobre el flow: qué pasa en el cerebro cuando una persona entra en ese estado de concentración total en el que el tiempo se distorsiona y el desempeño se dispara. El libro traza los disparadores concretos —riesgo, novedad, complejidad, retroalimentación inmediata— que permiten inducir ese estado, y explica por qué los deportes de riesgo extremo se convirtieron, sin proponérselo, en el laboratorio más avanzado del mundo para estudiarlo.

## El flow como habilidad entrenable, no como don

La idea central del libro es que el flow no es un rasgo de personalidad reservado para atletas de élite, sino un mecanismo neuroquímico —con su propia receta de dopamina, noradrenalina, endorfinas y anandamida— que se puede activar deliberadamente ajustando el entorno y el nivel de desafío. Eso lo vuelve tan relevante para un cirujano o un programador como para un surfista de olas grandes.

## Para quién es

Para quien le interesa el rendimiento humano desde la ciencia dura y no desde el discurso motivacional, y para cualquiera que haya sentido el flow alguna vez y quiera entender qué lo produjo.

> Por ahora disponible solo en inglés; el enlace lleva a la edición de New Harvest.
