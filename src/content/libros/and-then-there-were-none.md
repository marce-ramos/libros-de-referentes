...
Christie arma un problema de lógica cerrado: diez sospechosos, una isla sin salida, un asesino que tiene que estar necesariamente entre ellos. Cada muerte reduce el círculo de sospechosos y aumenta la paranoia del grupo, hasta un final que sigue discutiéndose casi noventa años después de publicado. Es el modelo fundacional del "misterio de cuarto cerrado" llevado a escala de isla entera.

## El mecanismo perfecto del misterio clásico

Lo que hizo escuela de esta novela no es solo el giro final, sino la estructura: cada capítulo cierra una posibilidad y abre otra, sin trampas baratas ni información oculta al lector. Todas las pistas están ahí, a la vista, y aun así casi nadie adivina la solución. Es el tipo de arquitectura narrativa que estudian generaciones de escritores de suspenso.
